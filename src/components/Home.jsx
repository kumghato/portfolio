            ...
            <div className='container_home pt-5 text-start d-flex justify-content-center' id='header'>
                <div className='row d-flex justify-content-evenly '>
                    <div className='col-lg-6 col-md-6 col-sm-12 intro'>
                        ...
                        <a href='https://drive.google.com/file/d/1r1gXH2XsOf2tzSITPLZdj0yPrCoHSj5U/view?usp=sharing' target='_blank' className='btn_custom px-5 py-2 text-center d-flex align-items-center justify-content-center'>Resume</a>
